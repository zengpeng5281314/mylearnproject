...
public class TimeLineModel implements Serializable {
    ...
    public TimeLineModel updateTimeLineModel(TimeLineModel timeLineModel) {
        ...
        if (timeLineModel.getOrg_id() != 0)
            this.org_id = timeLineModel.getOrg_id();
        if (timeLineModel.getCompany_id() != 0)
            this.company_id = timeLineModel.getCompany_id();
        if (timeLineModel.getContacts_id() != 0)
        ...
        if (timeLineModel.getCreate_userid() != 0)
        ...
        if (timeLineModel.getUpdate_userid() != 0)
